    ...
    class DriveMode:
        def run(self, mode,
            ...
            if mode == 'user':
                ...
                return pilot_angle if pilot_angle else 0.0, pilot_throttle * cfg.AI_THROTTLE_MULT, pilot_brake if pilot_throttle else 0.0, pilot_brake if pilot_brake else 0.0
